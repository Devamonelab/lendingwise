...
docker rm -f lendingwise-api 2>nul
docker rm -f lendingwise-sqs-worker 2>nul
docker rm -f lendingwise-cross-validation-watcher 2>nul
docker rm -f lendingwise-all-in-one 2>nul
echo.
